...
const CartPanel = () => {
  const { tokens, isCartOpen, setIsCartOpen, cartItems, cartTotal, updateCartQuantity, removeFromCart } = useMobileCardMenu();
        ...
        {isCartOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-[101] md:hidden rounded-t-3xl overflow-hidden"
              ...
              <div className="max-h-[85vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-5">
                  {cartItems.length === 0 ? (
                    <div className="text-center py-16">
                      <SafeIcon icon={FiIcons.FiShoppingCart} className="text-6xl text-gray-300 mx-auto mb-4" />
                    ...
                    <div className="space-y-4">
                      {cartItems.map(item => (
                        <div
                          key={item.id}
                          className={`${tokens.layout.borderRadius.card} p-4 transition-all ${tokens.effects.shadow.card}`}
                          style={{
                        ...
                        >
                          <div className="flex gap-4 mb-3">
                            ...
                            <button
                              ...
                              className="p-2 rounded-xl hover:bg-red-50 text-red-500 transition-all h-fit"
                            >
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              className="w-10 h-10 rounded-xl flex items-center justify-center font-bold bg-gray-100 hover:bg-gray-200 transition-all"
                            >
                ...
                {cartItems.length > 0 && (
                  ...
                  >
                    ...
                    <button
                      className={`w-full py-4 ${tokens.layout.borderRadius.button} font-bold text-base transition-all hover:scale-105 active:scale-95 ${tokens.effects.shadow.button}`}
                      style={{
        ...
        <div className="h-full flex flex-col">
          ...
          >
            ...
            <div
              ...
              style={{ backgroundColor: tokens.colors.primary }}
            >
              <SafeIcon icon={FiIcons.FiShoppingCart} className="text-white" />
            </div>
          </div>
