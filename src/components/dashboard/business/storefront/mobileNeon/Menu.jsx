        ...
        {displayProducts.map(product => (
          ...
          >
            <div className="relative w-full" style={{ height: '120px' }}>
              ...
              {product.calories && (
                <div
                  ...
                  style={{ backgroundColor: 'rgba(0,0,0,0.65)', color: tokens.colors.primary }}
                >
            ...
            <div className="p-2.5 flex flex-col flex-1">
              <p className="text-xs font-black leading-tight line-clamp-2 mb-1" style={{ color: tokens.colors.primaryText }}>
                {product.name}
              </p>
