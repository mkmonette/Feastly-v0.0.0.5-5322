        ...
        {displayProducts.map(product => (
          ...
          >
            ...
            <div className="px-3 py-2.5 flex items-center justify-between">
              <div>
                <p className="text-sm font-black leading-tight line-clamp-1" style={{ color: tokens.colors.primaryText }}>
                  {product.name}
                </p>
              ...
              <button
                ...
                className="w-8 h-8 rounded-full flex items-center justify-center transition-all hover:scale-110 active:scale-95 shrink-0 ml-3"
                style={{ backgroundColor: tokens.colors.primary }}
              >
                <SafeIcon icon={FiIcons.FiPlus} className="text-sm" style={{ color: tokens.colors.secondary }} />
              </button>
            </div>
          </div>
        ))}
