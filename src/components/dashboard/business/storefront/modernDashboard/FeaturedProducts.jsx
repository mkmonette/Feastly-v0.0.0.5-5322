...
export const FeaturedProducts = () => {
  const { tokens, featuredProducts, addToCart } = useModernDashboard();
  ...
  return (
    <section style={styles.section} id="featured">
      <div style={styles.header}>
        <h2 style={styles.title}>Featured Dishes</h2>
        <p style={styles.subtitle}>Our most popular and recommended items</p>
      </div>
