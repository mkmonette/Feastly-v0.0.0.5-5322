...
const PopularDishes = () => {
  const { settings, popularProducts, addToCart } = useModernDashboard();
  const { tokens } = settings;

  if (!settings.sections.popularDishes.visible) return null;
      ...
      >
        {popularProducts.map((product) => (
          ...
          >
            ...
            >
              <SafeIcon icon={FiIcons.FiTrendingUp} size={14} />
              Popular
            </div>
