...
const CartDrawer = () => {
  const { tokens, cartItems, cartTotal, updateCartQuantity, isCartOpen, setIsCartOpen } = useGrove();
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between px-6 py-5"
              ...
              <button onClick={() => setIsCartOpen(false)} className="p-2 rounded-full hover:bg-black/5 transition-all">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-3">
                  <SafeIcon icon={FiIcons.FiShoppingBag} className="text-4xl" style={{ color: tokens.colors.cardBorder }} />
                    ...
                    <div key={item.id} className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          style={{ borderColor: tokens.colors.cardBorder, color: tokens.colors.primaryText, backgroundColor: 'transparent' }}
                        >-</button>
