...
/* Grove card: full-width image top (no padding), white body below with name, full desc, price + green pill Add button */
const GroveCard = ({ product, tokens, onAdd }) => (
  ...
  >
    {/* Full-width image, no padding, rounded only on top via parent overflow-hidden */}
    <img
  ...
  return (
    <section className="py-14" style={{ backgroundColor: tokens.colors.background }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        {subtitle && (
          <p className="text-sm mb-8" style={{ color: tokens.colors.mutedText }}>{subtitle}</p>
        )}
