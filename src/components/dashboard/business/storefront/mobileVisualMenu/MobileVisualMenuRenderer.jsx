...
const SectionWrapper = ({ sectionId, children }) => {
  const { sectionsConfig, cartItemCount } = useMobileVisualMenu();
...
const MobileVisualMenuRenderer = () => {
  const { tokens } = useMobileVisualMenu();

  return (
    <div className="w-full relative flex justify-center" style={{ backgroundColor: tokens.colors.background }}>
...
export default MobileVisualMenuRenderer;
