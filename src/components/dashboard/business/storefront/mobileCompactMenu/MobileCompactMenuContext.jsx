...
const defaultSectionsConfig = [
  ...
  },
  {
    ...
    content: {
      ...
      subtitle: 'Get your favorite meals delivered hot and fresh to your doorstep',
  ...
  },
  {
    ...
    content: {
      title: 'Full Menu',
      titleHighlight: 'Menu',
      subtitle: 'Browse all available items'
    }
  },
  {
    id: 'banner',
      ...
      testimonials: [
        {
          ...
          content: 'Best food delivery service in town! Always fresh and hot.',
  ...
  },
  {
    ...
    content: {
      ...
      subtitle: 'Get started now and enjoy fresh food',
...
export const MobileCompactMenuProvider = ({ children }) => {
  const [tokens, setTokens] = useState(mobileCompactMenuTokens);
