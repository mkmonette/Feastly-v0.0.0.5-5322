...
const CategoryTabs = () => {
  const { tokens, products } = useMobileCompactMenu();
  ...
  return (
    <div
      className="sticky top-[73px] z-40 bg-white shadow-sm py-3 overflow-x-auto"
      style={{
        scrollbarWidth: 'none',
    ...
    >
      ...
      `}</style>
      <div className="flex gap-2 px-4 justify-start category-tabs-container">
