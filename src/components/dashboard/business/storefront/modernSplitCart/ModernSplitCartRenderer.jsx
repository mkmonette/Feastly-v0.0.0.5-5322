...
import { ModernSplitCartProvider } from './ModernSplitCartContext';
...
const ModernSplitCartRenderer = () => {
  return <ModernSplitCartContent />;
};

export default ModernSplitCartRenderer;
