...
const CartDrawer = () => {
  const { tokens, cartItems, cartTotal, updateCartQuantity, isCartOpen, setIsCartOpen } = useEmber();
      ...
      {isCartOpen && (
        <>
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#1A1A1A', borderLeft: `1px solid ${tokens.colors.footerBorder}` }}
          >
                    ...
                    <div key={item.id} className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          style={{ backgroundColor: tokens.colors.cardBorder, color: tokens.colors.primaryText }}
                        >-</button>
