...
const PLACEHOLDER_MENU = {
  ...
  Desserts: [
    ...
    { id: 'm17', name: 'Creme Brulee', description: 'Classic French custard with caramelized sugar crust', price: 9.50, cal: '350 cal', image: 'https://images.pexels.com/photos/3892469/pexels-photo-3892469.jpeg' }
  ]
};
  ...
  return (
    <section className="py-14" style={{ backgroundColor: tokens.colors.sectionAlt }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Tabs: amber active, dark bordered inactive */}
