...
const About = () => {
  ...
  const ImageSection = (
    <div style={{ position: 'relative' }}>
      ...
      >
        <img
          src={content.image || "https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&cs=tinysrgb&w=800"}
          alt="About"
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: tokens.spacing['2xl'], alignItems: 'center' }}>
        {imagePosition === 'left' ? (
          <>
            {ImageSection}
            {TextSection}
