          ...
          >
            <div className="relative w-full aspect-square overflow-hidden">
              ...
              <button
                ...
                className="absolute top-1.5 right-1.5 w-6 h-6 rounded-full flex items-center justify-center shadow-md transition-all hover:scale-110 active:scale-95"
                style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}
              >
                <SafeIcon icon={FiIcons.FiHeart} className="text-xs text-white" />
              </button>
              <button
                onClick={() => addToCart(product)}
                className="absolute bottom-1 right-1 w-6 h-6 rounded-full flex items-center justify-center shadow-md transition-all hover:scale-110 active:scale-95"
