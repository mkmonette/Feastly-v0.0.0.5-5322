      ...
      {isCartOpen && (
        <>
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(15,23,42,0.4)', backdropFilter: 'blur(6px)' }}
            data-testid="mosaic-cart-overlay"
          />
          <motion.aside
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
          ...
          >
            ...
            >
              <div>
                <div className="text-[10px] font-black uppercase tracking-[0.28em]" style={{ color: tokens.colors.textMuted }}>
                  Your bento box
                </div>
                <div
                      ...
                      >
                        ...
                        >
                          <button
                            ...
                            data-testid={`mosaic-cart-dec-${item.id}`}
                          >
                          ...
                          <button
                            ...
                            data-testid={`mosaic-cart-inc-${item.id}`}
                          >
            ...
            <div className="px-5 py-4" style={{ borderTop: `1px solid ${tokens.colors.border}` }}>
              <div className="flex items-center justify-between mb-3">
                <span className="text-[11px] font-black uppercase tracking-[0.24em]" style={{ color: tokens.colors.textMuted }}>
                  Subtotal
                </span>
                <span
              ...
              <button
                ...
                data-testid="mosaic-cart-checkout"
              >
                Checkout
