...
import { mosaicTokens } from '../mosaicTokens';
...
const defaultSectionsConfig = [
  {
    ...
    content: { brand: 'Mosaic', tagline: 'A modular kitchen' },
  },
  {
    id: 'hero',
    name: 'Hero',
    ...
    content: {
      ...
      title: 'Small tiles.\nBig flavor.',
      subtitle:
        'Order our most-loved dishes from the rail, or browse the full menu by category. We plate it all by hand.',
    },
  },
  {
    id: 'popular',
  ...
  },
  {
    ...
    content: {
      title: 'Our Menu',
      subtitle: 'Tap a category, then tap any tile to add it.',
    },
  },
  {
    id: 'promo',
...
export const MosaicProvider = ({ children }) => {
  const [tokens] = useState(mosaicTokens);
