      ...
      {isCartOpen && (
        <>
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(21,21,42,0.45)', backdropFilter: 'blur(6px)' }}
            data-testid="lumen-cart-overlay"
          />
          <motion.aside
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
          ...
          >
              ...
              {cartItems.length === 0 ? (
                <div className="text-center py-14">
                  ...
                  <p className="text-[12px] font-medium mt-1" style={{ color: tokens.colors.textMuted }}>
                    Tap any Popular Pick or menu item to start.
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        >
                          <button
                            ...
                            data-testid={`lumen-cart-dec-${item.id}`}
                          >
                          ...
                          <button
                            ...
                            data-testid={`lumen-cart-inc-${item.id}`}
                          >
            ...
            <div className="px-5 py-4" style={{ borderTop: `1px solid ${tokens.colors.border}` }}>
              ...
              <button
                ...
                data-testid="lumen-cart-checkout"
              >
                Checkout
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest text-center mt-3" style={{ color: tokens.colors.textSubtle }}>
                Pickup in 15 min · Delivery in 30 min
              </p>
            </div>
          </motion.aside>
        </>
