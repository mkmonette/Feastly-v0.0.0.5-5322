...
const PopularPicks = () => {
  ...
  return (
    <section className="relative pt-8 pb-2" data-testid="lumen-popular">
      <div className="max-w-[1400px] mx-auto px-5 lg:px-10">
        <div className="flex items-end justify-between gap-4 mb-5">
          <div>
            ...
            >
              <SafeIcon icon={FiIcons.FiTrendingUp} className="text-xs" style={{ color: tokens.colors.accent }} />
              <span
          ...
          <button
            ...
            data-testid="lumen-popular-see-all"
          >
            See all
          ...
          {popular.map((product, idx) => {
            ...
            return (
              <motion.div
                ...
                data-testid={`lumen-popular-card-${product.id}`}
              >
                <div className="relative aspect-[5/4] overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 flex items-center gap-1.5">
                    ...
                    {product.computedFlags?.bestSeller && (
                      ...
                      >
                        <SafeIcon icon={FiIcons.FiStar} className="text-[10px]" style={{ color: tokens.colors.accent }} />
                        Best
                      </span>
                    )}
                  </div>
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-3 flex items-end justify-between gap-2">
                    ...
                    <button
                      ...
                      data-testid={`lumen-popular-add-${product.id}`}
                    >
